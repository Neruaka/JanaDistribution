...
├── PROMPT_MASTER_SESSION.md           ← ton prompt de démarrage de session
└── .claude/
    └── agents/
...
2. Copier-coller le contenu de `PROMPT_MASTER_SESSION.md` dans le chat
...
# Dans le chat, taper :
> /task @.claude/agents/00_orchestrateur.md "Exécuter la session Phase 2 selon PROMPT_MASTER_SESSION.md"
```
...
2. Mettre à jour ETAT_ACTUEL_PROJET.md avec le nouvel état
