...
const ProductsTable = ({
  ...
  return (
    <div className="bg-white border border-sand-200 rounded-8 overflow-hidden">
      <div className="grid gap-3 px-[18px] py-2.5 bg-sand-100 border-b border-sand-200 text-[11.5px] tracking-wide text-graphite-400 items-center" style={{ gridTemplateColumns: GRID }}>
      ...
      {loading ? (
        ...
        products.map((product) => (
          <div
            key={product.id}
            className={`grid gap-3 items-center px-[18px] py-3 border-b border-sand-150 last:border-b-0 hover:bg-sand-50 transition-colors ${!product.estActif ? 'opacity-60' : ''}`}
