...
> ⚠️ **Document historique (état figé au 2026-06-14)** — Rédigé lors de l'audit initial, avant l'implémentation réelle de la facturation (Phase 5, DONE) et le retrait de Stripe (T4-07, 2026-07-02). Voir `ETAT_ACTUEL_PROJET.md` et `PLAN_CORRECTION_AUDIT.md` pour l'état réel à jour.
