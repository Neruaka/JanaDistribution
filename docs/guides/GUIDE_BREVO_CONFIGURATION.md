...
> **Gmail SMTP** (décision produit). Voir le nouveau guide : **`docs/guides/GUIDE_GMAIL_SMTP.md`**.
>
...
Voir `docs/workflow/ETAT_ACTUEL_PROJET.md` et `docs/workflow/PLAN_CORRECTION_AUDIT.md` pour l'état réel à jour.
