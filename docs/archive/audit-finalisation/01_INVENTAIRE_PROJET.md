...
├── .github/workflows/
├── README.md
├── docs/deploiement/README-CI-CD.md
├── docs/deploiement/DEPLOY-RAILWAY.md
...
| `docs/deploiement/README-CI-CD.md` | Documentation CI/CD GitHub Actions |
| `docs/deploiement/DEPLOY-RAILWAY.md` | Guide de déploiement Railway |
