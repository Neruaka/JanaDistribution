# PROMPT MAÎTRE — SESSION JANA DISTRIBUTION
# À coller tel quel dans Claude Code au démarrage de la session
...
- Tâche suivante recommandée dans ETAT_ACTUEL_PROJET.md : T2-01
...
au format CLAUDE_WORKFLOW.md §9 et met à jour :
1. PLAN_CORRECTION_AUDIT.md (compteurs + statuts)
2. ETAT_ACTUEL_PROJET.md (journal + prochaine action)
